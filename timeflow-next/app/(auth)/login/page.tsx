...
export default function LoginPage(props: { searchParams?: { error?: string } }): JSX.Element {
      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="mx-auto w-full max-w-md overflow-hidden rounded-2xl border border-slate-200 bg-surface shadow-card">
          <div className="grid grid-cols-2">
            ...
            <div className="rounded-tr-2xl bg-surface px-4 py-3 text-center text-sm text-textMuted">
              Регистрация
            </div>
          </div>
          ...
          <div className="space-y-5 px-8 py-8">
            ...
            <div className="pt-1 text-center text-sm text-textMuted">
              Нет аккаунта?{" "}
              <a href="/register" className="font-medium text-textMain underline">
                Зарегистрироваться
              </a>
            </div>
          </div>
